...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const machine_learningXML = moveCategory('machine_learning') || machineLearning(isInitialSetup, isStage, targetId, colors.machine_learning);
